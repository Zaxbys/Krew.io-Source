    ...
    return function (t) {
        ...
        var n = function () {
            ...
            return t.select = function (i, o) {
                ...
                return null != i ? (this.each(this.nodes, function (o) {
                    o.setAttribute(t, i)
        ...
        var n = o(8),
            ...
            p = function () {
                ...
                return Object.defineProperty(t, "defaultOptions", {
                    ...
                    t.instances = [], s.default.select("top-center" === t.position ? ".growl-notification-center" : ".growl-notification").each(function (t) {
                    ...
                    var t = this;
                    this.options.closeWith.indexOf("click") > -1 ? this.notification.addClass("growl-notification--close-on-click").on("click", function () {
                        return t.close()
                    }) : this.options.closeWith.indexOf("button") > -1 && this.notification.find(".growl-notification__close").on("click", function () {
                        return t.close()
        ...
        t.exports = function () {
            ...
            function e(i, s, r) {
                ...
                return c === Array.isArray(i) ? c ? r.arrayMerge(i, s, r) : function (t, i, n) {
                    var s = {};
